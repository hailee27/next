    ...
    <div className="font-notoSans sticky z-[100] top-0 bg-white">
      ...
      >
        ...
        <div
          aria-hidden="true"
          className={clsx(
            ' bg-white  py-[88px] px-[48px] w-[302px] border-[2px] border-[#333] border-r-[0px] min-h-[650px] absolute z-[1001]  duration-500 transition-all',
        ...
        >
          ...
          <div className="flex flex-col gap-[24px]">
            {MainNavigation.map((i) => (
              <a
                className={clsx('text-[20px] font-bold tracking-[0.6px]  ', i.text === 'Home' ? 'font-montserrat' : '')}
                href={i.to}
                key={i.to}
              >
                {i.text}
