...
const ClassTable = ({ objSearch }: PropsType) => {
  ...
  const tableFormat = [
    ...
    },
    {
      ...
      render: (description) => <div className="font-bold">{description}</div>,
    },
    {
      title: 'Created At',
      width: 200,
      dataIndex: 'createdAt',
      render: (createdAt) => <div className="font-bold">{dayjs(createdAt).format('DD-MM-YYYY')}</div>,
    },
    {
      title: 'Updated At',
      width: 200,
      dataIndex: 'updatedAt',
      render: (updatedAt) => <div className="font-bold">{dayjs(updatedAt).format('DD-MM-YYYY')}</div>,
    },
    {
      title: '',
