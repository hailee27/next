...
const BasicSelectClass: FC<PropsType> = ({ className, placeholder, onChange, value }) => {
  const { ref: boxInputRef, isComponentVisible, setIsComponentVisible } = useComponentVisible(false);

  const [trigger, { data: list, isFetching }] = useLazyGetListClassQuery();
...
export default BasicSelectClass;
